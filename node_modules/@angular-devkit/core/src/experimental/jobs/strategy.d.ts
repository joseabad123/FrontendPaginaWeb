...
export declare namespace strategy {
    type JobStrategy<A extends JsonValue, I extends JsonValue, O extends JsonValue> = (handler: JobHandler<A, I, O>, options?: Partial<Readonly<JobDescription>>) => JobHandler<A, I, O>;
    /**
